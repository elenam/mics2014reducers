...
These questions have major implications toward the usage of Clojure reducers and \clocode{pmap} in production enviroments; \clocode{pmap} has significant qualifiers that need to be addressed.

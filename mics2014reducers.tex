...
\caption{Parallel combinations in Compare-Sum-Primes, Box 1, Run 2}\label{figure:parallel}
\end{figure}

\begin{figure}[h!]
\includegraphics[trim = 10mm 10mm 10mm 30mm, clip, width = 16cm,height = 9.75cm]{SSP-B1}
\caption{Serial combinations in Compare-Sum-Primes, Box 1, Run 2}\label{figure:serial}
\end{figure}

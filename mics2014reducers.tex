...
\caption{Sum-Primes averages, (ms).}\label{table:sum-primes}
 In the first four tests, \clocode{reduce + map, reduce + pmap, r/fold + map, r/fold + pmap}, almost all run in serial time, except for Box 1, where \clocode{reduce + pmap} and \clocode{r/fold + pmap}
